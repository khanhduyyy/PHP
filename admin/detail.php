...
<table class='table'>
 ...
 <?php
  ...
  $i=1;
  $o=$a->getIn4CustomerByOrderID($_GET['ID']);
  //var_dump($o);
  echo"<div style='font-size:22px;margin-top:20px'>
  <u>Tên khách hàng: ".$o['Fullname']."</u>
  <u style='margin-left:500px;'>Số điện thoại: ".$o['PhoneNumber']."</u> 
  <p style='margin-top:20px;margin-bottom:100px;'>Địa chỉ: ".$o['Address']."</p>
  </div>";
  foreach ($ord as $key) {
  echo 
  "
