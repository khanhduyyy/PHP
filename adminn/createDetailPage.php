<?php
    function createPage($id,$tensp,$gia,$chatlieu,$mau,$hinhanh){
        $tenfile = convertStringToEnglish($tensp);
        $myfile = fopen("../../../../products/".$tenfile.".php","w") or die("Unable to open file!");
            ...
            <nav class="navbar sticky-top navbar-expand-md navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div class="user-nav">
                        ...
                        <a href="../user-php/shopping-cart.php" style="cursor: pointer;">
